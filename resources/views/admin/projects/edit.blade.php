...
<div class="container py-4">
    <div class="row mb-4">
        <div class="col">
            ...
            <h1 class="mb-0">
                <i class="bi bi-pencil"></i> Edit Project: {{ $project->name }}
            </h1>
        </div>
    </div>
        ...
        <div class="col-md-8">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.projects.update', $project) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Inactive projects are hidden from users</small>
                        </div>
            ...
            <div class="card shadow-sm mt-4">
                <div class="card-body">
                    ...
                    @else
                        <p class="text-muted mb-0">No users assigned to this project yet.</p>
                    @endif
                </div>
            </div>
        </div>
